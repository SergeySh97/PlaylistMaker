...
class PlaylistBottomSheetViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    private val playlistName: TextView = itemView.findViewById(R.id.tv_playlist_name_bottom_sheet)
    private val tracksCount: TextView = itemView.findViewById(R.id.tv_tracks_count_bottom_sheet)
